...
import EmojiQuiz from '../rounds/EmojiQuiz';
...
export default function GameScreen() {
  ...
  useEffect(() => {
    const onGameStart = () => setRound(1);
    const onRoundStart = () => setRound(1);
    const onScores = (data) => {
  ...
  return (
    <div className="min-h-screen bg-f1-dark flex flex-col">
      <header className="flex items-center justify-between px-4 py-2 bg-f1-card/80 border-b border-slate-700/50 shrink-0">
        <h1 className="font-syne text-lg text-white">Emoji Movie Quiz</h1>
